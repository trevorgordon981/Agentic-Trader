...
TICKER_NAMES = {
    ...
    "LUMN": ["lumen"],
    "SYMF": ["nokia"],
    "DRAQ": ["roundhill memory", "memory etf", "DRAQ"],
    "SOXL": ["direxion", "semiconductor bull", "semis 3x", "semiconductor 3x"],
    "SYMX": ["proshares ultrapro qqq", "ultrapro qqq", "nasdaq-100", "nasdaq 100"],
...
def main():
    ...
    lines = [
        ...
        "Fresh headlines for an operator watchlist tickers and the topics he follows.",
        "",
    ]
