...
D = os.path.expanduser("~/evaluation-harness/trading")
...
TARGETS = [
    ("AAPL", "2023-04-10", ("true",  "earn")),
    ("AAPL", "2022-10-29", ("true",  "noearn")),
    ("NVDA", "2023-08-10", ("proxy", "earn")),
    ("NVDA", "2023-03-10", ("proxy", "earn")),
    ("SPY",  "2023-06-15", ("proxy", "noearn")),
    ("IWM",  "2024-09-20", ("proxy", "noearn")),
    ("AAPL", "2023-07-20", ("true",  "earn")),
    ("SPY",  "2024-11-01", ("proxy", "noearn")),
]
...
for k, (t, dstr, want_path) in enumerate(TARGETS, 1):
    ...
    idxpos = h.index.searchsorted(tgt, side="right") - 1
    if idxpos < 420:
