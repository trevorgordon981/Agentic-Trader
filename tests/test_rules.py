...
class TestTrailingStop:
    ...
    def test_trailing_activated_not_triggered(self):
        ...
        # Entry = 5.00, activation = 50% (7.50), peak = 10.00
        # Trigger = peak - (peak - activation) * giveback = 10 - (2.5 * 0.5) = 8.75
        # Current = 9.00 > 8.75, no trigger
        trigger = evaluate_trailing_stop(
            current_price=9.0,
            entry_debit=500.0,
            quantity=1,
    ...
    def test_trailing_triggered(self):
        ...
        # Entry = 5.00, activation = 50% (7.50), peak = 10.00
        # Trigger = 8.75, current = 8.00 < 8.75
        trigger = evaluate_trailing_stop(
            current_price=8.0,
            entry_debit=500.0,
            quantity=1,
